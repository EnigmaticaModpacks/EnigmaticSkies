...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/iron`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/copper`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/gold`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/osmium`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/lead`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/silver`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/nickel`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/uranium`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/platinum`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/aluminum`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/zinc`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/iesnium`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/iridium`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/netherite`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/steel`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/electrum`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/bronze`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/invar`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/tungsten`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/obsidian`).getId(),
//                     count: 4
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/coal`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/charcoal`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/diamond`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/lapis`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/fluorite`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/quartz`).getId(),
//                     count: 1
//                 }
//             ],
//             multiply: 'none',
...
//             outputs: [
//                 {
//                     id: AlmostUnified.getTagTargetItem(`c:dusts/wood`).getId(),
//                     count: 12
//                 }
//             ],
//             multiply: 'none',
...
//                 result: {
//                     type: 'occultism:item',
//                     id: recipe.outputs[0].id,
//                     count: recipe.outputs[0].count
//                 },
