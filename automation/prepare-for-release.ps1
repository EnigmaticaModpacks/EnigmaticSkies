...
function Close-FixedIssues {
    ...
    Write-Host 
    Write-Host "NeoForge-1.21.1-$modloaderVersion | [Mod Updates](https://github.com/EnigmaticaModpacks/$MODPACK_NAME/blob/main/changelogs/changelog_mods_$MODPACK_VERSION.md) | [Modlist](https://github.com/EnigmaticaModpacks/$MODPACK_NAME/blob/main/changelogs/modlist_$MODPACK_VERSION.md)"
    Write-Host 
